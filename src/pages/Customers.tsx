    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white border border-gray-200 p-5 rounded-3xl shadow-sm">
        ...
        <button
          ...
          className="w-full sm:w-auto justify-center text-white px-4 py-2.5 rounded-xl font-bold flex items-center gap-2 text-xs shadow-md transition-all hover:scale-105 cursor-pointer btn-theme-secondary"
          style={{
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <button
              ...
              className="px-3.5 py-2.5 text-white font-bold text-xs rounded-xl flex items-center gap-1.5 shadow-sm transition-all cursor-pointer btn-theme-secondary"
              style={{
                backgroundColor: 'var(--theme-btn-secondary)',
                color: 'var(--theme-btn-text)'
              }}
