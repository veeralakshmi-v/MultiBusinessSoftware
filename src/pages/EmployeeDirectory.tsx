      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 bg-white/80 backdrop-blur-md border border-white/60 p-5 sm:p-6 rounded-3xl shadow-lg shadow-gray-200/50 w-full min-w-0">
        ...
        <div className="flex flex-col gap-2.5 w-full md:w-auto min-w-0">
          ...
          <button
            ...
            className="w-full md:w-auto px-4 py-2 font-bold text-xs uppercase tracking-wider rounded-xl shadow-lg flex items-center justify-center gap-2 transition-all flex-shrink-0 btn-theme-secondary"
            style={{
        ...
        <div className="flex items-center gap-1.5 justify-end flex-shrink-0">
          <button
            ...
            className={cn(
              ...
              viewMode === 'grid' ? "shadow-md border-transparent btn-theme-secondary" : "bg-white text-gray-600 border border-gray-100"
            )}
            style={viewMode === 'grid' ? {
              backgroundColor: 'var(--theme-btn-secondary)',
              color: 'var(--theme-btn-text)'
          ...
          <button
            ...
            className={cn(
              "px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-xl text-xs font-bold border transition-all cursor-pointer",
              viewMode === 'table' ? "shadow-md border-transparent btn-theme-secondary" : "bg-white text-gray-600 border border-gray-100"
            )}
            ...
            >
              ...
              <div className="mt-3 pt-2.5 border-t border-gray-100 flex items-center justify-between">
                <button
                  ...
                  className="px-3.5 py-1.5 text-white rounded-xl text-xs font-bold transition-all flex items-center gap-1 shadow-sm cursor-pointer btn-theme-secondary"
                  style={{
                    backgroundColor: 'var(--theme-btn-secondary)',
                    color: 'var(--theme-btn-text)'
                  }}
            ...
            <form onSubmit={handleSaveStaff} className="space-y-4">
              ...
              <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    type="submit"
                    className="px-6 py-2 font-bold rounded-xl text-xs shadow-lg flex items-center gap-1.5 cursor-pointer btn-theme-secondary"
                    style={{
                      backgroundColor: 'var(--theme-btn-secondary)',
                      color: 'var(--theme-btn-text)',
                      boxShadow: 'var(--theme-glow)'
