...
export default function EmployeeDirectory() {
  ...
  return (
    <div className="p-3 sm:p-6 md:p-8 space-y-4 sm:space-y-6 max-w-[1600px] mx-auto w-full min-w-0 overflow-hidden">
      ...
      {/* ── HEADER & CONTROLS ── */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 bg-[#131315] border border-[#1F1F21] p-3.5 sm:p-5 rounded-2xl shadow-xl w-full min-w-0">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0 flex-1">
            <h1 className="text-base sm:text-xl font-bold text-white font-serif tracking-wide truncate">Employee Directory</h1>
        ...
        <div className="flex flex-col gap-2.5 w-full md:w-auto min-w-0">
          ...
          <button
            ...
            className="w-full md:w-auto px-4 py-2 bg-gradient-to-r from-[#C5A059] to-[#9E7B35] hover:from-[#d4b06a] hover:to-[#b08d4a] text-[#080809] font-bold text-xs uppercase tracking-wider rounded-xl shadow-lg shadow-[#C5A059]/20 flex items-center justify-center gap-2 transition-all flex-shrink-0"
          >
