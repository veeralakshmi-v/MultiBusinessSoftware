        ...
        {[
          ...
          return (
            <button key={tab.id} onClick={() => setActiveTab(tab.id as typeof activeTab)}
              className={cn("px-3.5 sm:px-4 py-2 sm:py-2.5 text-xs font-bold rounded-xl transition-all flex items-center gap-2 whitespace-nowrap flex-shrink-0 cursor-pointer", active ? "shadow-md font-extrabold btn-theme-secondary" : "text-gray-600 hover:text-gray-900 hover:bg-gray-100/80")}
              style={active ? {
