    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white/80 backdrop-blur-md border border-white/60 p-5 rounded-3xl shadow-lg shadow-gray-200/50">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 font-bold text-sm tracking-wider rounded-xl transition-all shadow-lg cursor-pointer btn-theme-secondary"
            style={{
        ...
        {(['ALL', 'VACANT', 'OCCUPIED', 'RESERVED', 'CLEANING'] as const).map(s => (
          <button
            ...
            className={cn(
              ...
              filterStatus === s
                ? 'border-transparent btn-theme-secondary'
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-24 gap-3 text-gray-500 border-2 border-dashed border-gray-200 rounded-2xl">
          ...
          <button
            onClick={() => setShowAddModal(true)}
            className="mt-2 px-4 py-2 font-bold rounded-xl text-xs uppercase tracking-widest cursor-pointer btn-theme-secondary"
            style={{
              backgroundColor: 'var(--theme-btn-secondary)',
              color: 'var(--theme-btn-text)',
              boxShadow: 'var(--theme-glow)'
          ...
          <div className="bg-white border border-gray-200 rounded-2xl w-full max-w-sm shadow-2xl" onClick={e => e.stopPropagation()}>
            ...
            <div className="p-4 space-y-4">
              ...
              <button
                ...
                className="w-full py-2.5 font-bold rounded-xl transition-all disabled:opacity-50 flex items-center justify-center gap-2 cursor-pointer btn-theme-secondary"
                style={{
                  backgroundColor: 'var(--theme-btn-secondary)',
                  color: 'var(--theme-btn-text)',
                  boxShadow: 'var(--theme-glow)'
