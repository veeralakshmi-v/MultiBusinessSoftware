  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white/80 backdrop-blur-md border border-white/60 p-5 rounded-3xl shadow-lg shadow-gray-200/50">
        <div>
          <div className="flex items-center gap-2">
            <Building2 className="w-6 h-6" style={{ color: 'var(--theme-text-accent)' }} />
      ...
      <div className="flex items-center gap-1.5 border-b border-gray-200 pb-2 overflow-x-auto no-scrollbar touch-pan-x">
        <button
          ...
          className={cn(
            ...
            activeTab === 'profile'
              ? "btn-theme-secondary font-extrabold shadow-md"
      ...
      {activeTab === 'profile' && (
        <form onSubmit={handleSaveSettings} className="bg-white/90 border border-gray-100 rounded-2xl p-6 shadow-lg shadow-gray-200/40 space-y-6">
          <h3 className="font-bold text-gray-900 text-base border-b border-gray-200 pb-3 flex items-center gap-2">
            <Building2 className="w-5 h-5" style={{ color: 'var(--theme-text-accent)' }} />
          ...
          <div className="flex justify-end pt-4 border-t border-gray-200">
            <button
              type="submit"
              className="px-6 py-2.5 font-bold text-xs rounded-xl shadow-lg hover:brightness-110 flex items-center gap-2 cursor-pointer transition-all"
              style={{
                backgroundColor: 'var(--theme-btn-secondary)',
                color: 'var(--theme-btn-text)',
                boxShadow: 'var(--theme-glow)'
      ...
      {activeTab === 'billing' && (
        <form onSubmit={handleSaveSettings} className="bg-white/90 border border-gray-100 rounded-2xl p-6 shadow-lg shadow-gray-200/40 space-y-6">
          <h3 className="font-bold text-gray-900 text-base border-b border-gray-200 pb-3 flex items-center gap-2">
            <Printer className="w-5 h-5" style={{ color: 'var(--theme-text-accent)' }} />
      ...
      {activeTab === 'staff' && (
        <div className="bg-white/90 border border-gray-100 rounded-2xl p-6 shadow-lg shadow-gray-200/40 space-y-5">
          <div className="flex items-center justify-between border-b border-gray-200 pb-3">
            <div className="flex items-center gap-2">
              <Users className="w-5 h-5" style={{ color: 'var(--theme-text-accent)' }} />
              <h3 className="font-bold text-gray-900 text-base">Cashier & Staff Accounts</h3>
            </div>
            <button
              onClick={() => handleOpenStaffModal()}
              className="px-4 py-2 font-bold text-xs rounded-xl shadow-md hover:scale-105 active:scale-95 transition-all flex items-center gap-1.5 cursor-pointer"
              style={{
                backgroundColor: 'var(--theme-btn-secondary)',
                color: 'var(--theme-btn-text)',
                boxShadow: 'var(--theme-glow)'
            ...
            <table className="w-full text-left text-xs">
              <thead className="bg-gray-50 text-gray-400 font-bold uppercase text-[10px] border-b border-gray-200">
                <tr>
                  ...
                  <th className="p-3.5 whitespace-nowrap" style={{ color: 'var(--theme-text-accent)' }}>Aadhar No. *</th>
              ...
              <tbody className="divide-y divide-gray-100">
                {staffList.map(st => (
                  <tr key={st.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="p-3.5 font-mono font-bold text-[11px] whitespace-nowrap" style={{ color: 'var(--theme-text-accent)' }}>
          ...
          <div className="bg-white border border-gray-200 rounded-3xl w-full max-w-2xl p-6 shadow-2xl space-y-4 my-8 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSaveStaff} className="space-y-4">
              ...
              <div className="flex items-center gap-4 p-3 bg-gray-50 border border-gray-200 rounded-xl">
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-2 pt-0.5">
                    ...
                    >
                      <Upload className="w-3.5 h-3.5" style={{ color: 'var(--theme-text-accent)' }} />
              ...
              <div className="flex justify-end gap-2 pt-3 border-t border-gray-200">
                ...
                <button
                  type="submit"
                  className="px-6 py-2 font-bold rounded-xl text-xs hover:scale-105 active:scale-95 transition-all cursor-pointer btn-theme-secondary"
                  style={{
                    backgroundColor: 'var(--theme-btn-secondary)',
                    color: 'var(--theme-btn-text)',
                    boxShadow: 'var(--theme-glow)'
        ...
        <form onSubmit={handleSaveLanding} className="space-y-6">
          ...
          <div className="bg-white/90 border border-gray-100 rounded-2xl p-6 shadow-lg shadow-gray-200/40">
            <h3 className="font-bold text-gray-900 text-base border-b border-gray-200 pb-3 flex items-center gap-2 mb-5">
              <ImageIcon className="w-5 h-5" style={{ color: 'var(--theme-text-accent)' }} />
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="space-y-3">
                ...
                >
                  <Upload className="w-4 h-4" style={{ color: 'var(--theme-text-accent)' }} />
                  Choose Logo File
                </button>
                {businessProfile.logoUrl && (
                  <button
          ...
          <div className="bg-white/90 border border-gray-100 rounded-2xl p-6 shadow-lg shadow-gray-200/40">
            <h3 className="font-bold text-gray-900 text-base border-b border-gray-200 pb-3 flex items-center gap-2 mb-5">
              <FileText className="w-5 h-5" style={{ color: 'var(--theme-text-accent)' }} />
          ...
          <div className="bg-white/90 border border-gray-100 rounded-2xl p-6 shadow-lg shadow-gray-200/40">
            <div className="flex items-center justify-between border-b border-gray-200 pb-3 mb-5">
              <h3 className="font-bold text-gray-900 text-base flex items-center gap-2">
                <Monitor className="w-5 h-5" style={{ color: 'var(--theme-text-accent)' }} />
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                type="submit"
                className="px-6 py-2.5 font-bold text-xs uppercase tracking-wider rounded-xl hover:scale-105 active:scale-95 transition-all flex items-center gap-2 cursor-pointer btn-theme-secondary"
                style={{
                  backgroundColor: 'var(--theme-btn-secondary)',
                  color: 'var(--theme-btn-text)',
                  boxShadow: 'var(--theme-glow)'
        ...
        <div className="space-y-6">
          <form onSubmit={handleChangeAdminPassword} className="bg-white/90 border border-gray-100 rounded-2xl p-6 shadow-lg shadow-gray-200/40 space-y-5 max-w-2xl">
            ...
            <div className="pt-2 flex justify-end">
              <button
                type="submit"
                className="px-6 py-2.5 font-bold text-xs uppercase tracking-wider rounded-xl flex items-center gap-2 hover:scale-105 active:scale-95 transition-all cursor-pointer btn-theme-secondary"
                style={{
                  backgroundColor: 'var(--theme-btn-secondary)',
                  color: 'var(--theme-btn-text)',
                  boxShadow: 'var(--theme-glow)'
