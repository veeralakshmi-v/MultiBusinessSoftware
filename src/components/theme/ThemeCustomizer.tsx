    ...
    <form onSubmit={handleSave} className="space-y-6 max-w-7xl mx-auto pb-10">
        ...
        <div className="flex items-center justify-between border-b border-gray-100 pb-3">
          <div>
            <h3 className="font-bold text-gray-900 text-base flex items-center gap-2">
              <Image className="w-5 h-5 flex-shrink-0" style={{ color: 'var(--theme-text-accent)' }} />
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-gray-100 pb-4 gap-3">
          <div>
            <h3 className="font-bold text-gray-900 text-base flex items-center gap-2">
              <Palette className="w-5 h-5 flex-shrink-0" style={{ color: 'var(--theme-text-accent)' }} />
        ...
        <div className="p-4 rounded-2xl bg-gradient-to-r from-blue-50/50 to-indigo-50/50 border border-blue-200/80 space-y-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-4 py-2.5 font-bold text-xs rounded-xl shadow-sm transition-all flex items-center gap-1.5 cursor-pointer flex-shrink-0 btn-theme-secondary"
              style={{
      ...
      <div className="flex justify-end pt-2">
        <button
          type="submit"
          className="px-7 py-3 font-bold text-sm tracking-wider uppercase rounded-xl shadow-lg hover:shadow-xl flex items-center gap-2.5 transition-all cursor-pointer hover:scale-105 active:scale-95 btn-theme-secondary"
          style={{
            backgroundColor: 'var(--theme-btn-secondary)',
            color: 'var(--theme-btn-text)',
