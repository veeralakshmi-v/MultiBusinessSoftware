    ...
    <form onSubmit={handleSave} className="space-y-6">
      ...
      <div className="bg-[#131315] border border-[#1F1F21] rounded-2xl p-6 shadow-xl space-y-4">
        <div className="flex items-center justify-between border-b border-[#1F1F21] pb-3">
          ...
          <span className="px-2.5 py-1 rounded-full bg-[#1A1A1C] border border-[#2D2D30] text-[10px] text-theme-secondary font-mono">
            {businessType}
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full bg-[#0A0A0B] border border-[#2D2D30] rounded-xl px-3 py-2 text-sm text-white outline-none focus:border-theme-secondary"
            />
          </div>
          ...
          <div className="space-y-1.5 md:col-span-2">
            ...
            <div className="flex items-center gap-3">
              <input
                ...
                className="flex-1 bg-[#0A0A0B] border border-[#2D2D30] rounded-xl px-3 py-2 text-sm text-white outline-none focus:border-theme-secondary"
              />
              <div className="w-10 h-10 rounded-xl bg-[#0A0A0B] border border-[#2D2D30] flex items-center justify-center text-theme-secondary font-serif font-bold text-base flex-shrink-0">
                {config.logoUrl ? (
      ...
      <div className="bg-[#131315] border border-[#1F1F21] rounded-2xl p-6 shadow-xl space-y-5">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-[#1F1F21] pb-3 gap-2">
          <div>
            <h3 className="font-bold text-white text-base flex items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#1A1A1C] border border-[#2D2D30] text-xs text-gray-300 hover:text-white hover:border-gray-500 transition-all"
            >
              <RotateCcw className="w-3.5 h-3.5" />
              <span>Reset Default</span>
            </button>
            <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#0A0A0B] border border-[#2D2D30]">
              ...
              return (
                ...
                >
                  <div className="min-w-0 flex-1">
                    <p className="font-bold text-white text-xs truncate transition-colors" style={{ color: isSelected ? preset.secondaryBtn : '#FFFFFF' }}>
                      {preset.name}
                    </p>
        ...
        <div className="p-4 bg-[#0A0A0B] border border-[#1F1F21] rounded-2xl space-y-3">
          <div className="flex items-center justify-between">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
            ...
            <div className="space-y-1.5 p-3 rounded-xl bg-[#131315] border border-[#1F1F21]">
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  onChange={e => handleCustomPrimaryBg(e.target.value)}
                  placeholder="#0A0A0B"
                  className="w-full bg-[#0A0A0B] border border-[#2D2D30] rounded-xl px-2.5 py-1.5 text-xs text-white font-mono outline-none focus:border-theme-secondary"
                />
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-3 border-t border-[#1F1F21]">
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              className="w-full bg-[#0A0A0B] border border-[#2D2D30] rounded-xl px-3 py-2 text-xs text-white outline-none focus:border-theme-secondary"
            />
          </div>
          ...
          <div className="flex items-center gap-6 pt-1 md:col-span-2 text-xs text-gray-300">
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                className="rounded bg-[#0A0A0B] border-[#2D2D30] text-theme-secondary focus:ring-0"
              />
