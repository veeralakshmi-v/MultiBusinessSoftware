...
export const BRANCH_GEOFENCE_LOCATIONS: { id: string; name: string; latitude: number; longitude: number; geofenceRadiusMeters: number }[] = [];
...
export class GeoLocationEngine {
  ...
  private static memoryLogs: GeoAttendanceRecord[] = [];
